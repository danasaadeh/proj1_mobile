...
class UpdateTripPassenger extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<EditPassengerCubit>(context).getFilters();
    return CustomScaffold(
      imagePath: "lib/images/Android Small - 1.png",
      child: BlocConsumer<EditPassengerCubit, EditPassengerState>(
        listener: (context, state) {
          if (state is EditPassengerSuccess) {
          ...
          } else if (state is EditPassengerFailure) {
        ...
        builder: (context, state) {
          if (state is EditPassengerLoading) {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropDown(
                        ...
                        isdropSelected: true,
                        dataList:
                            BlocProvider.of<EditPassengerCubit>(context).cities,
                      ...
                      child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              print(selectedCity);
                              print(data.id);
                              BlocProvider.of<EditPassengerCubit>(context)
                                  .EditTripPassenger(
                                      id: data.id,
